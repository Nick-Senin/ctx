...
use ctx_history_capture::{
    ...
    import_auggie_history, import_claude_history_jsonl, import_claude_projects_jsonl_tree,
    ...
    AuggieImportOptions, CaptureError, CatalogSummary, ClaudeHistoryImportOptions,
