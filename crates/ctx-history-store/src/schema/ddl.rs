...
CREATE TABLE IF NOT EXISTS events (
    ...
    message_authorship TEXT NOT NULL DEFAULT 'unknown' CHECK (message_authorship IN ('human', 'automated', 'unknown')),
    message_authorship_evidence TEXT NOT NULL DEFAULT 'ambiguous',
    message_authorship_classifier_version INTEGER NOT NULL DEFAULT 0 CHECK (message_authorship_classifier_version >= 0),
